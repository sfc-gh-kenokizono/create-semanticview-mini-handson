...
```
┌────────────────────────────────────────────────────────────────────┐
│  0:00                    0:15           0:45           0:55   1:00 │
│    │                       │              │              │      │  │
│    ▼                       ▼              ▼              ▼      ▼  │
│ ┌──────┐ ┌────────────────────┐ ┌────────────┐ ┌──────┐ ┌────┐ │
│ │導入  │ │  Step 1: 手動作成  │ │Step 2: AI  │ │比較  │ │Q&A │ │
│ │説明  │ │   （苦労体験）     │ │ （便利体験）│ │振返り│ │    │ │
│ └──────┘ └────────────────────┘ └────────────┘ └──────┘ └────┘ │
│  15min        30min              10min         10min    5min     │
└────────────────────────────────────────────────────────────────────┘
```
...
2. **説明文入力**
   ...
   ```
3. **サンプルSQL入力**（sample_queries.sqlから2-3個）
4. **「生成」クリック** → 「✨ 今、AIが分析しています...」
5. **結果確認** → 「リレーションシップが自動で検出されました！」
